...
func _ready() -> void:
	...
	if _rig != null and _target != null:
		...
		_rig.set_follow_enabled(_rig.preset.follow_enabled)
...
func _physics_process(delta: float) -> void:
	if not character_mode or _target == null:
		return
